...
import (
	...
	_ 5220//"github.com/FloatTech/ZeroBot-Plugin/plugin/coser"            // 三次元小姐姐
	...
	// "github.com/FloatTech/ZeroBot-Plugin/plugin/kfccrazythursday" // 疯狂星期四
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "sinabot", "Set default nickname.")
